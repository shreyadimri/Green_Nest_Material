...
SA_SMDH_published<- rma.mv(
  yi = SMDH_sign, # specify lnRR as the effect size measure;
...
SMDH_design_flagged_no_missingE <-
  metafor::rma.mv(
    yi = SMDH_sign, # specify lnRR as the effect size measure;
    V = VCV_SMDH_design_flagged_no_missingES ,# specify lnRR's sampling variance;
    mods = ~ - 1 + comparision_type,
    random = list(~ 1 | paper_ID,
                  ~ 1 | Observation_ID,
                  ~ 1 | group_ID_coded,
...
## NOT run
## save to RDS file
save(SA_lnRR_VCV_range, file = here::here("model/sensitivity_analysis/SA_lnRR_VCV_range.RData"))
```
...
save(SA_SMDH_VCV_range, 
     file = here::here("model/sensitivity_analysis/SA_SMDH_VCV_range.Rdata"))
```
...
SA_SMDH_no_comp1<- rma.mv(
  yi = SMDH_sign, # specify lnRR as the effect size measure;
  V = VCV_SMDH_no_comp1, # specify lnRR's sampling variance-covariance matrix;
  mods = ~ 1,
  random = list(~ 1 | paper_ID,
                ~ 1 | Observation_ID,
                ~ 1 | group_ID_coded,
...
SMDH_hypothesis_no_comp1 <- metafor::rma.mv(
  yi = SMDH_sign, # specify lnRR as the effect size measure;
  V = VCV_SMDH_no_comp1,# specify lnRR's sampling variance;
  mods = ~ - 1 + Hypothesis,
  random = list(~ 1 | paper_ID,
                ~ 1 | Observation_ID,
                ~ 1 | group_ID_coded,
...
```{r}
#----------------------------------------------------------------------------
## Now re-running all the 5 meta-regressions once again
#----------------------------------------------------------------------------

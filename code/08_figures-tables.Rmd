...
## Table: PRISMA Checklist

```{r}

pacman::p_load(kableExtra)
prisma_checklist <- read_csv("tables/SA_prisma_checklist.csv")

prisma_checklist<-prisma_checklist %>%
  kbl(
    col.names = c("Checklist item", "Item score", "Sub-item number",
                  "Sub-item", "Reported by authors?", "Notes"),
    booktabs = TRUE,
    longtable = TRUE
  ) %>%
  kable_styling(
...
save_kable(prisma_checklist, "tables/prisma_checklist.png")
...
save_kable(own_library_table, "tables/initial_library.png")

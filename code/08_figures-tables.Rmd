...
merged_data_extraction <- read_csv(here::here("data/03_data_cleaning/merged_data_extraction.csv"),
                                   show_col_types = F)
...
print(excluded_proxies)
```

```{r excluded_proxies_table.pdf, eval=FALSE}
## save image file
gtsave(data = excluded_proxies,

...
Another hypothesis to explain the adaptive benefit of GNM is the widely tested nest protection hypothesis (NPH), which proposes that volatile compounds in green material reduce parasite abundance or pathogen loads, indirectly enhancing offspring survival. In an influential early comparitive study in raptors (Falconiformes), @wimberger1984 found indirect evidence for the reduction of ectoparasites in the nests with green nest material. @clark1988 later provided experimental support in European Starlings, showing that preferred herbs contained insect-repellent and antimicrobial volatile. They also outlined key criteria for evaluation of the NPH, including selective plant use, bioactive chemical properties and demonstrable adaptive benefits. Field observation and experimental studies on raptors [@ontiveros2007; @dykstra2009] and passerines [@dawson2004; @lafuma2001; @mennerat2009b; @quiroga2012] have shown mixed results, and in some cases, GNM improved nestling condition without reducing parasite abundance [@gwinner2000]. These findings led to the development of drug hypothesis, which suggests that the aromatic GNM directly enhance nestling development or immune function, independent of the parasite control [@gwinner2000; @mennerat2009a]. Thus, while both hypotheses posit adaptive benefits of GNM, the drug hypothesis emphasizes a pharmacological mechanism, and the two are not mutually exclusive. Several other adaptive functions of GNM have also been proposed. These functions do not refer to the aromatic properties of GM, but could still provide some benefits such as enhance the crypticity of the nest [@skutch1957], provide insulation for eggs and nestling [@mertens1977], provide protection from sun, signal nest occupancy or simply fill the gaps between nesting materials [@lyons1987]. These alternative functional roles have received little support or attention.

Despite several observational and experimental studies and two crucial narrative reviews [@dubiec2013; @scott-baumann2015], a comprehensive quantitative synthesis across studies and hypotheses has been lacking. This has limited our understanding of the generality and magnitude of GNM effects on fitness benefits. To address this gap, we conducted a systematic review and meta-analysis to assess the overall effect of GNM on various fitness proxies. We explicitly evaluate the evidence for the courtship and parental-care- the latter combining the nest protection and drug hypotheses due to their non-exclusivity. The drug hypothesis can only be supported by improved nestling health while ensuring that GNM has no protective effect against any parasite or pathogen.

In addition to testing these primary hypotheses, we further explore the context-dependency in the research field and examine the potential sources of variation in the results (heterogeneity) in the GNM effects. Specifically, we explored whether the effect of GNM varied depending on the type of parasite (arthropods vs. microorganisms), the timing of GNM addition (e.g., before hatching, after hatching, or continuously), the experimental design (e.g., aromatic vs. non-aromatic vs. no added material), the focal species, and the type of fitness trait measured (e.g., physiology, morphology, reproduction). These exploratory moderators could allow us to assess context dependence and identify ecological or methodological patterns that may explain inconsistencies in previous findings. Together, our evidence synthesis approach provides the first quantitative test of the adaptive value of green nest material across bird species and research contexts.
